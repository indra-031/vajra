#!/usr/bin/env python3
# extraction/js/libraries-js.py
# Extract JS libraries and versions from downloaded JS files
# Reads from : targets/<DOMAIN>/download/js
# Writes to  : targets/<DOMAIN>/extraction/js/libraries.json
...
def main():
    if len(sys.argv) != 2:
        print("Usage: libraries-js.py <domain>")
        sys.exit(1)
    ...
    if count == 0:
        ...
        # print(f" Saved to: targets/{domain}/extraction/js/libraries.json")
