#!/usr/bin/env python3
# extraction/js/comments-js.py
# Extract ALL JavaScript comments using a lexer-style state machine
# Reads from : targets/<DOMAIN>/download/js
# Writes to  : targets/<DOMAIN>/extraction/js/comments.txt
...
def main():
    if len(sys.argv) != 2:
        print("Usage: comments-js.py <domain>")
        sys.exit(1)
    ...
    if count == 0:
        ...
        pass
        # print("[✓] DONE")
        # print(f" Saved to: targets/{domain}/extraction/js/comments.txt")
